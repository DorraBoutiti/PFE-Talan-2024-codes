...
const Horsprod = () => {
    ...
    useEffect(() => {
        ...
        const fetchUserProfile = async () => {
            try {
                ...
                const depList = ['RH','HORS_PRODUCTION'];
    ...
    return (
      ...
      <iframe title="Hors prod" width="1100" height="800" src="https://app.powerbi.com/reportEmbed?reportId=88984599-023c-4857-93c5-22e3a0483349&autoAuth=true&ctid=6f07f79b-03b1-44e1-b221-7fa1001b22ac" frameBorder="0" allowFullScreen="true"></iframe>
      <PowerBIEmbed
