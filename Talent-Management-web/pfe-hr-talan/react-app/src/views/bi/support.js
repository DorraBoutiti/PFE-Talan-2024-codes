    ...
    useEffect(() => {
        ...
        const fetchUserProfile = async () => {
            try {
                ...
                const depList = ['RH','SUPPORT_PRODUCTION'];
    ...
    return (
        <MainCard title="Sample Card">
            <iframe
                ...
                width="1100"
                height="800"
                src="https://app.powerbi.com/reportEmbed?reportId=324893ab-e39d-4018-867f-35947b5fbd61&autoAuth=true&ctid=6f07f79b-03b1-44e1-b221-7fa1001b22ac"
                frameBorder="0"
