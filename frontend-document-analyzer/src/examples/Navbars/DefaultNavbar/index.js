...
import { SearchResultsList } from "components/SearchBar/components/SearchResultsList";
  ...
  return (
    <Container>
      <div style={{ position: "relative" }}>
        {" "}
        {/* Container for both SearchBar and SearchResultsList */}
        <SoftBox
          py={1.5}
        ...
        >
          ...
          <SoftBox color="inherit" display="flex" alignItems="center" flexGrow={1}>
            <SearchBar setResults={setResults} style={{ margin: "0 auto" }} />
          </SoftBox>
